...
public class EditTaskController implements Initializable
{
	...
	private void handleTaskSubmitListener(ActionEvent event) throws IOException
	{
		...
		Priority priority;
		if(priorityFieldTask.getValue() == (Priority.LOW))
		{
			priority = Priority.LOW;
		}
		else if(priorityFieldTask.getValue() == (Priority.MEDIUM))
		{
	...
	public void setTask(Task t)
	{
		...
		datePicker.setValue(LocalDate.of(currentTask.getDueDate().getYear(), currentTask.getDueDate().getMonth(), currentTask.getDueDate().getDayOfMonth()));
