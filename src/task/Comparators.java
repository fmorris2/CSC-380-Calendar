...
/**
 * This class contains the various Comparator objects
 * that the system will use to compare tasks.
 * 
 * This is an easy and efficient way to sort tasks. With
 * these comparators, we will be able to use Collections.sort
 * to sort collections of Tasks quickly and conveniently.
 * 
 * @author Freddy
 */
