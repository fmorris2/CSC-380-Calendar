...
public class GroupTest
{
	...
	public void test()
	{
		...
		assertTrue("The permissions of a new user did not match up (setPermissions)",
				test.getUserPermissions().get(userTest).getCanChangeTasks());
		assertTrue("The permissions of a new user did not match up (setPermissions)",
				test.getUserPermissions().get(userTest).getCanCompleteTasks());
		assertTrue("The permissions of a new user did not match up (setPermissions)",
				test.getUserPermissions().get(userTest).getCanCreateTasks());
